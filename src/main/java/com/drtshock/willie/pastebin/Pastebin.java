...
public class Pastebin {
    ...
    /**
     * Logs in to Pastebin. This is automatically run once on startup and should not be run again unless a future paste
     * should be pasted for a different user.
     *
     ...
     * @param format language of the code (available languages: pastebin.com/api#5")
     *
    ...
    /**
     * Sets the API key to use. This is run automatically on startup and does not need to be run again unless needed.
     *
